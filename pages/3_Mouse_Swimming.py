...
# 页面标题和说明
st.title("🐁 小鼠游泳分析 / Mouse Swimming Analysis")
...
# 设置路径和时间
root_directory = os.path.join(get_data_path(), 'mouse_swimming')
...
# 设置模型
models = {
    "ICR-DJ-Swimming-V2": os.path.join(get_models_path(), "DJ-swimming-500px-narrow-2024-05-13/config.yaml"),
    "C57-DJ-Swimming-V2": os.path.join(get_models_path(), "C57-Swimming-T2-2024-05-15/config.yaml")
}
